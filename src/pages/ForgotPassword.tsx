      ...
      <div className="max-w-md mx-auto px-4 py-12">
        <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <p className="text-slate-500 mt-1">
            Password reset is only available when the app is connected to the backend. Set{' '}
            <code className="bg-slate-100 px-1 rounded">VITE_PROXY_API=true</code> or{' '}
            <code className="bg-slate-100 px-1 rounded">VITE_API_URL</code> and run the server.
          </p>
          <p className="mt-6">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        {done ? (
          <div className="mt-8 space-y-4">
            <div className="rounded-lg bg-green-50 text-green-800 px-4 py-3 text-sm">
            ...
            {resetLink && (
              <div className="rounded-lg bg-amber-50 border border-amber-200 text-amber-800 px-4 py-3 text-sm">
                ...
                <br />
                <a href={resetLink} className="text-teal-600 underline break-all">
                  {resetLink}
                </a>
              </div>
            )}
